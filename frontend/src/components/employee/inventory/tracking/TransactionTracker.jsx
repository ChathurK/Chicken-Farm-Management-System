...
import InventoryModal from '../../../shared/InventoryModal';

/**
 * Component for tracking inventory transactions for employees
 * Allows employees to record stock in and stock out transactions
 */
const TransactionTracker = ({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Use the API to update the inventory quantity
