...
const Livestock = () => {
  ...
  const handleTabChange = (tab) => {
    if (tab !== type) {
      navigate(`/employee/livestock/${tab}`);
    }
  };
    ...
    <DashboardLayout>
      <div className="flex h-full flex-col rounded-lg bg-white p-6 shadow">
        ...
        <Pagination
          ...
          currentPageFirstItemIndex={paginationData.currentPageFirstItemIndex + 1}
          currentPageLastItemIndex={paginationData.currentPageLastItemIndex + 1}
