...
import { SidebarItem, SubMenu } from './SidebarItem';
import { House, CalendarDots, ShoppingCart, CurrencyCircleDollar, Bird, ArchiveBox, Storefront, UserPlus, UsersThree } from '@phosphor-icons/react';
