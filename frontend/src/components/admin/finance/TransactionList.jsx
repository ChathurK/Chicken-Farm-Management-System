...
import { Plus, MagnifyingGlass, Funnel, ArrowUp, ArrowDown, DotsThree, Calendar, Export, Trash, Eye, Pencil, CurrencyDollar, ArrowsHorizontal, CaretRight, CaretLeft, Bird, Egg } from '@phosphor-icons/react';
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const transactionsRes = await api.get(`/api/transactions?${queryParams}`);
        
        // Fetch total count for pagination
        const countRes = await api.get(`/api/transactions/count?${queryParams}`);
                  ...
                  <tr key={transaction.transaction_id} className="hover:bg-gray-50">
                    ...
                    <td className="whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
                      <div className="flex justify-end space-x-2">
                        ...
                        <button
                          onClick={() => navigate(`/admin/finance/transactions/edit/${transaction.transaction_id}`)}
            ...
            <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
              <div>
                <p className="text-sm text-gray-700">
                  ...
                  <span className="font-medium">{Math.min(currentPage * perPage, transactions.length)}</span> of{' '}
