...
const SellerForm = () => {
  ...
  // Load seller data if in edit mode
  useEffect(() => {
    if (isEditMode) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditMode) {
        await api.put(`/api/sellers/${id}`, formData);
      } else {
          ...
          <div className="mb-6 grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div>
              ...
              <input
                ...
                className={`border bg-gray-50 ${formErrors.first_name ? 'border-red-500' : 'border-gray-300'
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`border bg-gray-50 ${formErrors.last_name ? 'border-red-500' : 'border-gray-300'
                  } block w-full rounded-lg p-2.5 text-sm text-gray-900 focus:border-amber-500 focus:outline-none focus:ring-amber-500`}
            ...
            <div>
              ...
              <input
                ...
                className={`border bg-gray-50 ${formErrors.contact_number ? 'border-red-500' : 'border-gray-300'
                  } block w-full rounded-lg p-2.5 text-sm text-gray-900 focus:border-amber-500 focus:outline-none focus:ring-amber-500`}
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`border bg-gray-50 ${formErrors.email ? 'border-red-500' : 'border-gray-300'
                  } block w-full rounded-lg p-2.5 text-sm text-gray-900 focus:border-amber-500 focus:outline-none focus:ring-amber-500`}
